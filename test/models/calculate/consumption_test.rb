...
class Calculate::ConsumptionTest < ActiveSupport::TestCase
  ...
  def test_must_expire_after_date
    ...
    assert_equal expire_after_date, Calculate::Consumption.must_expire_after_date(from: Date.new(2024, 1, 1), num_of_days: 10)
  end
  ...
  def test_must_expire_after_date_no_from_specified
    travel_to Time.zone.parse("2025-10-02 09:00:00") do
      ...
      assert_equal expire_after_date, Calculate::Consumption.must_expire_after_date(num_of_days: 10)
    end
  end
end
